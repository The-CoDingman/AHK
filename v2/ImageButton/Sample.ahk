...
Button1 := ImageButton(MainGui, "x10 y10", "Button1.bmp")
...
if (A_IsCompiled) {
    BackgroundImage := MainGui.Add("Picture", "x0 y0 w700 h600 0x200 AltSubmit BackgroundTrans", "HBITMAP:" ImageButton.LoadImageFromResource("background.jpg"))
}
else {
